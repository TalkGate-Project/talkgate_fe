...
export default function FeePaymentStatusPanel() {
  ...
  return (
    ...
    <div className="space-y-0 lg:space-y-9">
      ...
      <section className="surface rounded-none md:rounded-b-[14px] md:rounded-t-none lg:rounded-[14px] px-6 md:px-7 pt-6 pb-[30px] shadow-none lg:shadow-[0_13px_61px_rgba(169,169,169,0.12)] dark:shadow-none">
