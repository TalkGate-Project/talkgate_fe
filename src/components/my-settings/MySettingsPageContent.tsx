...
export default function MySettingsPageContent() {
  return (
    <main className="min-h-screen bg-card md:bg-background md:pt-9 md:pb-12">
      <div className="container mx-auto max-w-[1324px] px-0 md:px-6 lg:px-0">
        <Suspense fallback={
          <div className="flex gap-6">
            <div className="hidden md:block w-[280px] bg-card rounded-[14px] shadow-none lg:shadow-sm p-6">
