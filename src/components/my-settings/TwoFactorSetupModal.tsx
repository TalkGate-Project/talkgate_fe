    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="flex items-center justify-between px-7 py-6">
          ...
          <button
            onClick={onClose}
            className="text-neutral-50 hover:text-neutral-60 transition-colors cursor-pointer"
          >
        ...
        {/* Step 1: 인증 앱 설정 */}
        <div className="px-7">
          <h3 className="text-[16px] font-semibold leading-[1] text-foreground tracking-[0.2px] mb-1">
            1단계 : 인증 앱 설정
          </h3>
          <p className="text-[14px] font-medium text-neutral-60 leading-[1] mb-3">
            Google Authenticator, Authy 등의 인증 앱으로 아래 QR 코드를 스캔하세요.
          </p>

          {/* Divider */}
          <div className="w-full h-[1px] bg-border opacity-50 mb-[30px]"></div>

          {/* QR Code Section */}
          <div className="bg-muted rounded-[12px] p-4 flex gap-6">
            {/* QR Code */}
            ...
            <div className="flex flex-col justify-center">
              <p className="text-[14px] font-medium text-neutral-60 leading-[1] tracking-[0.2px] mb-2">
                수동 입력 코드
              </p>
              <div className="flex gap-3 mb-2">
                <div className="flex items-center h-[34px] px-3 bg-card border border-border rounded-[5px] min-w-[307px]">
              ...
              <p className="text-[14px] font-medium text-neutral-60 leading-[1]">
        ...
        <div className="px-7 mt-[30px]">
          ...
          {/* Code Input Section */}
          <div className="bg-muted rounded-[5px] px-6 py-3 flex items-center gap-3">
            {/* Code Input */}
            <div className="flex items-center h-[34px] px-3 py-2 bg-card border border-border rounded-[5px] w-[137px]">
              <input
                ref={inputRef}
                type="text"
                inputMode="numeric"
            ...
            <button
              ...
              className="h-[34px] px-3 bg-card border border-border rounded-[5px] text-[14px] font-semibold text-foreground tracking-[-0.02em] hover:bg-muted transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
            >
              취소
            </button>
