...
function Toggle({ enabled, onChange }: ToggleProps) {
  return (
    <button
      ...
      className={`w-10 h-6 rounded-full transition-colors flex items-center p-0.5 ${enabled ? "bg-[#00E272]" : "bg-[#D0D0D0]"
        }`}
    >
      <div
        ...
        {twoFactorEnabled && showSetup && (
          <div className="mt-8 space-y-8">
            ...
            <div>
              ...
              {/* QR Code Container */}
              <div className="w-full bg-[#F8F8F8] rounded-[12px] p-4 mb-4 flex items-center justify-start">
