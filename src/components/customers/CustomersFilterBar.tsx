...
export default function CustomersFilterBar({
  ...
  return (
    <div className="mb-2 md:mb-3 flex flex-wrap items-end gap-x-3 gap-y-2">
      {/* 필터 버튼: 레이블 높이만큼 위 여백 후 같은 가로 라인에 배치 */}
      <div className="flex flex-col shrink-0">
        <span className="block h-[14px] mb-1" aria-hidden="true" />
      ...
      {/* 이름: 레이블 위, 입력은 아래 같은 가로 라인 */}
      <div className="flex flex-col min-w-0 flex-1 md:max-w-[236px]">
      ...
      {/* 신청시간: 레이블 위, 날짜 범위 + 퀵 버튼은 아래 같은 가로 라인 (필터 모달과 연동) */}
