...
export default function CustomerCreateModal({
  ...
  return (
    <BaseModal
      ...
      containerClassName="relative w-[848px] md:w-[848px] h-[523px] rounded-[14px] bg-card dark:bg-neutral-10"
      ariaLabel="고객 등록"
    >
      <div className="relative w-full h-full flex flex-col">
        ...
        <div className="border-t border-neutral-30 dark:border-neutral-30 px-7 py-3 flex justify-end gap-3">
          <button
            ...
            onClick={handleReset}
            disabled={submitting}
            className="cursor-pointer h-[34px] px-3 rounded-[5px] border border-neutral-30 dark:border-neutral-30 text-[14px] font-semibold tracking-[-0.02em] text-ink dark:text-neutral-80 bg-card dark:bg-neutral-10 disabled:opacity-60"
          >
            초기화
          </button>
          <button
