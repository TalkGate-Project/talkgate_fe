      ...
      >
        <div className="flex items-center gap-2">
          ...
          {showAssignButton && (
            <button
              type="button"
              className="cursor-pointer h-9 min-w-[36px] px-2 rounded-[5px] bg-neutral-90 dark:bg-neutral-90 text-neutral-20 dark:text-neutral-25 inline-flex items-center justify-center gap-1.5 hover:opacity-90 transition-opacity"
            ...
            >
              ...
              <span className="text-[14px] font-semibold tracking-[-0.02em]">직원배정</span>
            </button>
          )}
        </div>
        <button
