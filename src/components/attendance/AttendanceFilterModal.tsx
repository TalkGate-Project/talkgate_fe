    ...
    >
        ...
        <div className="px-4 md:px-7 pt-4 md:pt-7 pb-3 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div className="text-[18px] leading-[21px] font-semibold text-black dark:text-neutral-80">필터설정</div>
          </div>
          <button
            onClick={onClose}
            aria-label="close"
        ...
        <div className="px-4 md:px-7 pt-[18px] pb-7 space-y-3 md:space-y-6 overflow-y-auto flex-1">
          ...
          <div>
            <div className="text-[14px] text-[#808080] dark:text-neutral-60 mb-2">직급</div>
            <div className="flex flex-wrap gap-2">
              {[
