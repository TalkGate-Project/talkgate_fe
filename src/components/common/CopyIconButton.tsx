...
function CopyIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <rect x="1" y="1" width="34" height="34" rx="5" className="fill-white dark:fill-[#111111]" />
      <rect x="0.5" y="0.5" width="35" height="35" rx="5.5" className="stroke-[#E2E2E2] dark:stroke-[#4D4D4D]" />
      <path
