    ...
    <div className="flex flex-col gap-4 px-6 py-4">
      {data.map((member) => {
        ...
        return (
          <div
            key={member.id}
            className={`relative flex h-[44px] w-[153px] flex-none cursor-move items-center gap-2 rounded-[12px] border border-neutral-30 bg-neutral-10 px-4 shadow-none transition-all hover:shadow-[0_3px_10px_rgba(0,0,0,0.12)] dark:hover:shadow-[0_3px_10px_rgba(0,0,0,0.35)] ${
