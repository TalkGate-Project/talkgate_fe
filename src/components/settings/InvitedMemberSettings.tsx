    ...
    <>
      <div className="flex items-center py-4 w-full">
        ...
        <div className="flex-[0.5] flex justify-center">
          ...
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M19 7L18.1327 19.1425C18.0579 20.1891 17.187 21 16.1378 21H7.86224C6.81296 21 5.94208 20.1891 5.86732 19.1425L5 7M10 11V17M14 11V17M15 7V4C15 3.44772 14.5523 3 14 3H10C9.44772 3 9 3.44772 9 4V7M4 7H20" stroke="var(--neutral-50)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        </div>
      </div>
    ...
    <div className="bg-card rounded-[14px] p-6">
      ...
      <div className="bg-neutral-20 rounded-[12px] px-6 py-3 mb-4">
        <div className="flex items-center w-full">
          {/* Email - 가장 넓게 */}
          <div className="flex-[3] text-[16px] font-bold text-neutral-60 text-left">
            이메일
          </div>
          {/* Invitation Date - 중간 크기 */}
