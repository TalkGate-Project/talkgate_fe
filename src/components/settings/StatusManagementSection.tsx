...
import { getStatusPaletteDotColor } from "@/utils/statusColors";
    ...
    >
      <span className="flex w-full items-center justify-between">
        <span
          ...
          style={{ backgroundColor: getStatusPaletteDotColor(color) }}
        />
...
export default function StatusManagementSection({
  ...
  return (
    <div className="md:bg-card md:rounded-[14px] lg:shadow-sm px-6 md:px-7 md:py-[30px] mt-5 md:mt-0">
                ...
                {isEditing ? (
                  ...
                  <>
                    <span
                      ...
                      style={{ backgroundColor: getStatusPaletteDotColor(status.colorCode) }}
                      aria-hidden="true"
                    />
