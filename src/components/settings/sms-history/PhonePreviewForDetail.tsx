...
import { usePhoneDragScroll } from "@/components/customers/sms/usePhoneDragScroll";
import type { SmsAdvertisementType } from "@/types/sms";

type PhonePreviewForDetailProps = {
  senderNumber: string;
  title: string;
  body: string;
  imageUrls: string[];
  contentType: SmsAdvertisementType;
};

export default function PhonePreviewForDetail({
  senderNumber,
  title,
  body,
  imageUrls,
  contentType,
}: PhonePreviewForDetailProps) {
