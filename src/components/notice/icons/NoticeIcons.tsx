...
export function NoticeMegaphoneIcon({ className = "" }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
...
export function NoticeUsersIcon({ className = "" }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
...
export function NoticeCogIcon({ className = "" }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
...
export function NoticeShieldIcon({ className = "" }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
