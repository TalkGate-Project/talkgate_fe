  ...
  return (
    <div className="absolute -right-10 top-[50px] w-[360px] max-[1080px]:right-5 max-[1280px]:right-4 max-[1080px]:w-[320px] bg-card dark:bg-neutral-10 rounded-[10px] shadow-[0px_18px_28px_rgba(9,30,66,0.1)] dark:shadow-[0px_13px_61px_0px_#000000B2] py-5 z-50">
      ...
      <div className="flex flex-col gap-1">
        ...
        <button
          className={`cursor-pointer flex items-center ${variant === "full" ? "h-[52px]" : "py-5"} gap-4 px-7 transition-colors ${
            isGuideHovered ? "bg-[var(--notification-unread-bg)]" : ""
          }`}
        ...
        >
          <div className={`transition-colors ${isGuideHovered ? "text-primary-60" : "text-neutral-60"}`}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <span
            className={`text-[16px] tracking-[-0.02em] ${
              isGuideHovered ? "font-bold text-primary-60" : "font-medium text-neutral-60"
            }`}
          >
            이용가이드
          </span>
        ...
        {typeof isDarkMode === "boolean" && onToggleTheme && (
          <button
            className={`cursor-pointer flex items-center ${variant === "full" ? "h-[52px]" : "py-5"} gap-4 px-7 transition-colors hover:bg-[var(--notification-unread-bg)]`}
          ...
          >
            ...
            <span className="text-[16px] font-medium text-neutral-60 tracking-[-0.02em] flex-1 text-left">
              {isDarkMode ? "다크모드" : "라이트모드"}
            </span>
            <div
              className={`relative w-10 h-6 rounded-full flex-shrink-0 p-[3px] transition-colors ${
                !isDarkMode ? "bg-primary-60" : "bg-neutral-40"
              }`}
              aria-hidden
            >
              <div
