  ...
  return (
    <div className="fixed inset-0 z-[120]">
      ...
      <div className="absolute left-1/2 top-1/2 w-[440px] -translate-x-1/2 -translate-y-1/2">
        <div className="relative w-full rounded-[16px] bg-white shadow-[0px_28px_80px_rgba(38,38,38,0.18)] px-7 py-6">
          <button
            aria-label="close"
            onClick={onClose}
          ...
          <h2 className="text-[18px] font-semibold text-neutral-light-60">
            고객 연동 방식 선택
          </h2>
          <p className="mt-[30px] text-[14px] text-[#6B7280] text-center">
            고객 정보 연동 방식을 선택해주세요.
          </p>
          ...
          <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <button
              ...
              className="group h-[156px] max-w-[186px] rounded-[14px] border border-[#E2E2E2] bg-[#F8FFFC] p-[18px] text-left transition-all hover:-translate-y-1 hover:border-[#00C97E] hover:shadow-[0_12px_32px_rgba(0,201,126,0.18)]"
            >
              <svg
                width="48"
                height="48"
              ...
              <div className="mt-1 text-[14px] text-neutral-light-60">
            ...
            <button
              ...
              className="group h-[156px] max-w-[186px] rounded-[14px] border border-[#E2E2E2] bg-[#F6F8FF] p-[18px] text-left transition-all hover:-translate-y-1 hover:border-[#4D82F3] hover:shadow-[0_12px_32px_rgba(77,130,243,0.18)]"
            >
              <svg
                width="48"
                height="48"
