      ...
      >
        ...
        >
          ...
          >
            ...
            <input name="email" placeholder="이메일을 입력하세요" className="w-full h-[40px] rounded-[5px] border border-[#555555] bg-transparent px-3 text-white" />
            <label className="block text-[#CECECE] text-[12px] mt-3 mb-1">비밀번호</label>
            <input name="password" type="password" placeholder="비밀번호를 입력하세요" className="w-full h-[40px] rounded-[5px] border border-[#555555] bg-transparent px-3 text-white" />
