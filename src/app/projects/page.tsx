  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#111111]">
      <div className="max-w-[1428px] mx-auto px-6 pt-24 pb-24">
        <h1 className="text-[32px] leading-[38px] font-bold text-[#252525] text-center">
          프로젝트 선택
        </h1>
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {projects.map((p: any) => (
            <div
              key={p.id}
              className="md:min-w-[688px] cursor-pointer rounded-[14px] shadow-[0_13px_61px_rgba(169,169,169,0.37)] bg-white p-6 border border-transparent hover:border-primary-60 hover:translate-y-[-20px] transition-colors transition-transform duration-300 ease-out"
              onClick={() => {
              ...
              <div className="grid grid-cols-2 gap-6 mt-5">
                <div className="rounded-[14px] bg-white shadow-[6px_6px_54px_rgba(0,0,0,0.05)] p-5 flex items-center justify-between">
                  <div>
                    ...
                    <div className="mt-2 text-[28px] font-bold tracking-[1px] text-[#252525]">
