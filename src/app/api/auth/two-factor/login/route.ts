...
export async function POST(request: NextRequest) {
  try {
    ...
    if (accessToken) {
      ...
      console.log('[2FA Login API] 🍪 access_token 쿠키 설정:', {
    ...
    if (refreshToken) {
      ...
      console.log('[2FA Login API] 🍪 refresh_token 쿠키 설정:', {
    ...
    console.log('[2FA Login API] ✅ 로그인 성공 - 응답 데이터:', {
    ...
    console.log('[2FA Login API] 📋 Set-Cookie 헤더:', setCookieHeaders);
